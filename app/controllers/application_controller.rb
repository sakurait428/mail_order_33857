class ApplicationController < ActionController::Base
  ...
  def configure_permitted_parameters
    ...
    devise_parameter_sanitizer.permit(:account_update, keys: [:last_name, :first_name, :last_name_kana, :first_name_kana, :last_name, :user_birth_date, :postal_code, :prefecture_id, :city, :block, :phone_number])
  end
